$.fn.extend({ChatSocket: function(opciones) {
         ...
         $('#'+idOnline).append('<ul class="list-group" id="listaOnline"><li class="list-group-item active">'+lblUsuariosOnline+'</li></ul>');
